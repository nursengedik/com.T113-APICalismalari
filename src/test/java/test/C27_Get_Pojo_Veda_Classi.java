...
public class C27_Get_Pojo_Veda_Classi extends DummyBaseURL {
    ...
    public void get01(){
        ...
        //expected data'yı istersek json obje istersek map veya pojo olarak hazırlayabiliriz
        //objeleri oluştururken de en içteki katmandan başlıyoruz
        ...
        DummyExpBodyPOJO resPojo = response.as(DummyExpBodyPOJO.class);//response'ı pojo'yo çeviriyoruz
