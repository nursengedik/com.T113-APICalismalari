...
public class C13_Get_SoftAssertIleExpectedDataTesti {
    ...
    gonderdigimizde donen response’un asagidaki gibi oldugunu (expected data hazırlama) test edin.
    ...
    public void get01(){
        ...
        // 1 - Url hazirla (Get methodu olduğu için request body hazırlamıyoruz)
     ...
     */
        //Nested Json obje olduğu için öncelikle içteki obje oluşturulur
        ...
        // 4 - Assertion
        //SoftAssert işlemlerinde parametre olarak önce actual data daha sonra expected data yazılır

        SoftAssert softAssert = new SoftAssert();

        JsonPath respJP = response.jsonPath();//response jsonPath'e çeviriyoruz
